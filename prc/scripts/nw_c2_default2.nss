...
// * if not runnning normal or better Ai then exit for performance reasons
    ...
    {
//        Jug_Debug(GetName(OBJECT_SELF) + " lost perceived " + GetName(oLastPerceived) + " " + IntToString(GetObjectSeen(oLastPerceived)));
    ...
    else if(GetLastPerceptionSeen() && !GetIsObjectValid(GetAttemptedAttackTarget()) && !GetIsObjectValid(GetAttemptedSpellTarget()))
    {
