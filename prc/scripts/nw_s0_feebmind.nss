...
// End of Spell Cast Hook
    ...
    int nDuration = (GetCasterLevel(OBJECT_SELF) + GetChangesToCasterLevel(OBJECT_SELF))/2;
    int nLoss = (GetCasterLevel(OBJECT_SELF) + GetChangesToCasterLevel(OBJECT_SELF))/4;
