...
float HenchGetFollowDistance()
{
    ...
    if(GetAssociateStateNPC(NW_ASC_DISTANCE_2_METERS))
    {
        fDistance = 2.0;
    }
    else if(GetAssociateStateNPC(NW_ASC_DISTANCE_4_METERS))
    {
        fDistance = 4.0;
    }
    else if(GetAssociateStateNPC(NW_ASC_DISTANCE_6_METERS))
    {
        fDistance = 6.0;
    }
    return fDistance;
