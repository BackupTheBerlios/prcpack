...
//::
//:: changed GetCasterLevel GetCasterLevel + GetChangesToCasterLevel  in 2 places
//:: the spellsCure section, and  in CalcNumberOfAttacks - to reflect prc caster levels.
//::
...
{
  int n = GetCasterLevel(OBJECT_SELF) + GetChangesToCasterLevel(OBJECT_SELF);
