...
void RunHandImpact(object oTarget, object oCaster)
{
    ...
    int nCasterModifiers = GetCasterAbilityModifier(oCaster) + (GetCasterLevel(oCaster) + GetChangesToCasterLevel(oCaster));
...
SetLocalInt(OBJECT_SELF, "X2_L_LAST_SPELLSCHOOL_VAR", SPELL_SCHOOL_EVOCATION);
    ...
    */
    ...
    if(!GetIsReactionTypeFriendly(oTarget))
    {
        ...
        int nResult = MyPRCResistSpell(OBJECT_SELF, oTarget);
