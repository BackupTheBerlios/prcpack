...
//
const int FEAT_SMITE_CONFIRMING  = 3255;
const int FEAT_SMITE_HOLY        = 3257;
const int FEAT_SMITE_FIEND       = 3258;
...
// Foe Hunter Feats - WILL UPDATE AFTER 2da's are finished.. required for script compile
